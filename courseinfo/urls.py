...
from courseinfo.views import (
    InstructorList, SectionList, CourseList,
    RegistrationList, SemesterList, StudentList, InstructorDetail,
    SectionDetail, SemesterDetail, CourseDetail, RegistrationDetail,
    StudentDetail, InstructorCreate, SectionCreate, CourseCreate,
    SemesterCreate, StudentCreate, RegistrationCreate, InstructorUpdate,
    CourseUpdate, SectionUpdate, SemesterUpdate, StudentUpdate,
    RegistrationUpdate, RegistrationDelete, InstructorDelete, CourseDelete,
    SectionDelete, SemesterDelete, StudentDelete
)
